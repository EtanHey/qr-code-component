...
export default function Home() {
  return (
    <div className={`flex h-full max-h-[62vh] w-full max-w-fit flex-col items-center justify-start gap-6 rounded-2xl bg-qrWhite p-4 text-center`}>
      <Image className='rounded-lg' height={280} width={280} alt='qr code' src={'/image-qr-code.png'} />
      <div className='flex max-w-[260px] flex-col gap-4 pb-14'>
